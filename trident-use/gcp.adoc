...
* *CVS-Performance*：Trident 的預設服務類型。這種效能最佳化型服務類型最適合注重效能的生產工作負載。CVS-Performance 服務類型是一種硬體選項，支援最小 100 GiB 的磁碟區。您可以選擇以下選項之一link:https://docs.cloud.google.com/netapp/volumes/docs/discover/overview["三種服務層級"^]：
+
** `standard`
** `premium`
** `extreme`
